    ...
    */
    ...
    for (let i = 0; i < simpsons.length; i++) {
        ...
        document.write(`<div><b>NAME</b> - ${simpson.name} <b>AGE</b> - ${simpson.age} <b>INFO</b> - ${simpson.info} </div><br>`)
        console.log(`NAME - ${simpson.name} AGE - ${simpson.age} INFO - ${simpson.info}`);
    };

    // template2.2
    for (let simpson of simpsons) {
        document.write('<div>');
        document.write(`<h2>NAME - ${simpson.name}, SURNAME - ${simpson.surname}. age is ${simpson.age}</h2>`);
        document.write(`<p>INFO - ${simpson.info}</p>`);
        document.write(`<img src="${simpson.photo}" alt="Photo ${simpson.name}" class="simpson-image">`);
        document.write('</div>');
    };
    ...
    */
    ...
    for (let product of products) {
        ...
        document.write(`<h3 class="product-title">TITLE - ${product.title}. ${product.price} - PRICE</h3>`);
